...
$inactivitypad = $inactivitythreshold + 15 #pad this date by 15 days because this attribute is only replicated periodically
$reportdata = search-adaccount -accountinactive -computersonly -timespan $inactivitypad | Where-Object { $_.enabled } | select-object -property name, distinguishedname, lastlogondate | Sort-Object -Property lastlogondate, name
New-Report -ReportName $ReportName -Title $Title -Subtitle $Subtitle -ReportData $reportdata
